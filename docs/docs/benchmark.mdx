...
When evaluating what LLM to use, it's important to consider the model's "smartness" - which you can get an idea of with the following benchmark results. With these, you can determine which size and quality your use case requires. 
